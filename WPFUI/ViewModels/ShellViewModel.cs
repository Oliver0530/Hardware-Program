...
namespace WPFUI.ViewModels
{
    ...
    public class ShellViewModel : Conductor<object>
    {
        ...
        private BindableCollection<TotalPriceModel> _TotalPrice = new BindableCollection<TotalPriceModel>();


        public ShellViewModel()
        {
            HardwareTypes.Add(new HardwareModel { HardwareType = "RTX 3090", Price = 10.0 });
            HardwareTypes.Add(new HardwareModel { HardwareType = "RTX 3080", Price = 5.0 });
            HardwareTypes.Add(new HardwareModel { HardwareType = "RTX 3070ti", Price = 15.0 });
        ...
        public HardwareModel SelectedHardware
        {
            ...
            set
            {
                ...
                NotifyOfPropertyChange(() => SelectedHardware);
            }
        }
        ...
        public RamModel SelectedRam
        {
            ...
            {
                _SelectedRam = value;
                NotifyOfPropertyChange(() => SelectedRam);
            }
        }
        //RamModel - End
